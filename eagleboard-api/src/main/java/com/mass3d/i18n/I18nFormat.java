...
import com.mass3d.period.BiWeeklyAbstractPeriodType;
...
public class I18nFormat {
  ...
  public void init() {
    String[] months = {"month.january", "month.february", "month.march", "month.april", "month.may",
        "month.june",
    ...
    String[] shortMonths = {"month.short.january", "month.short.february", "month.short.march",
        "month.short.april", "month.short.may", "month.short.june", "month.short.july",
        "month.short.august",
        "month.short.september", "month.short.october", "month.short.november",
        "month.short.december"};
    String[] weekdays = {"weekday.sunday", "weekday.monday", "weekday.tuesday", "weekday.wednesday",
        "weekday.thursday", "weekday.friday", "weekday.saturday"};
    String[] shortWeekdays = {"weekday.short.sunday", "weekday.short.monday",
  ...
  public String formatPeriod(Period period) {
    ...
    if (periodType instanceof WeeklyAbstractPeriodType) // Use ISO dates due to potential week confusion
    {
      ...
      LocalDate date = Instant.ofEpochMilli(period.getStartDate().getTime())
      ...
      if (calendar.isIso8601()) {
        ...
        DateTimeUnit date = biWeeklyAbstractPeriodType
            .adjustToStartOfBiWeek(dateTimeUnit, calendar);
