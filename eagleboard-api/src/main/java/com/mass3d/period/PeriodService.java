...
public interface PeriodService {
   ...
   * @param periods the collection of Periods.
   * @return all Periods from the given list of Periods which span the border of either the start
   * date or end date of the given Period.
   */
   ...
   *
   * @return a list of all PeriodTypes, or an empty list if there are no PeriodTypes. The
   * PeriodTypes have a natural order.
   */
