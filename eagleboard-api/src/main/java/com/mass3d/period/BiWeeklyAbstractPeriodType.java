...
public class BiWeeklyAbstractPeriodType
  ...
  protected BiWeeklyAbstractPeriodType(String name, int startOfWeek, String isoFormat,
      String isoDuration,
  ...
  @Override
  protected DateTimeUnit getDateWithOffset(DateTimeUnit dateTimeUnit, int offset,
      Calendar calendar) {
