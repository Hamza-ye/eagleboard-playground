...
public class DateTimeUnit {
  ...
  /**
   * TimeZone for this dateTime instance, defaults to the local tz, used when converting to/from
   * joda/jdk calenders.
   */
  ...
  public static DateTimeUnit fromJodaDateTime(DateTime dateTime, boolean iso8601) {
    ...
    dateTimeUnit
        .setTime(dateTime.getHourOfDay(), dateTime.getMinuteOfHour(), dateTime.getSecondOfMinute(),
  ...
  public DateTime toJodaDateTime(Chronology chronology) {
    try {
      ...
      LocalDateTime localDateTime = new LocalDateTime(year, month, day, hour, minute, second,
          millis,
  ...
  public boolean equals(Object o) {
    ...
    return year == that.year;// if ( !timeZone.equals( that.timeZone ) ) return false;
