...
public class NepaliCalendar extends AbstractCalendar {
  ...
  private static final DateTimeUnit START_NEPAL = new DateTimeUnit(2000, 1, 1,
      java.util.Calendar.WEDNESDAY);

  private static final DateTimeUnit START_ISO = new DateTimeUnit(1943, 4, 14,
      java.util.Calendar.WEDNESDAY, true);

  private static final Calendar SELF = new NepaliCalendar();
  /**
   * Map that gives an array of month lengths based on Nepali year lookup. Index 1 - 12 is used for
  ...
  public int isoWeek(DateTimeUnit dateTimeUnit) {
    DateTime dateTime = toIso(dateTimeUnit).toJodaDateTime(ISOChronology
