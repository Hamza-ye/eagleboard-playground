...
import com.mass3d.calendar.AbstractCalendar;
...
import com.mass3d.calendar.exception.InvalidCalendarParametersException;
...
public class PersianCalendar extends AbstractCalendar {
  ...
  private static final DateTimeUnit START_PERSIAN = new DateTimeUnit(1353, 1, 1,
      java.util.Calendar.THURSDAY);

  private static final DateTimeUnit START_ISO = new DateTimeUnit(1974, 3, 21,
      java.util.Calendar.THURSDAY, true);

  private static final DateTimeUnit STOP_PERSIAN = new DateTimeUnit(1418, 12, 29,
      java.util.Calendar.MONDAY);

  private static final DateTimeUnit STOP_ISO = new DateTimeUnit(2040, 3, 19,
      java.util.Calendar.MONDAY, true);

  private static final Calendar SELF = new PersianCalendar();
  /**
   * Map that gives an array of month lengths based on Persian year lookup. Index 1 - 12 is used for
   * months, index 0 is used to give year total (lazy calculated).
   */
  ...
  public DateTimeUnit toIso(DateTimeUnit dateTimeUnit) {
    ...
    if (dateTimeUnit.getYear() >= START_ISO.getYear() && dateTimeUnit.getYear() <= STOP_ISO
        .getYear()) {
      return new DateTimeUnit(dateTimeUnit.getYear(), dateTimeUnit.getMonth(),
          dateTimeUnit.getDay(),
  ...
  public DateTimeUnit isoStartOfYear(int year) {
    int day = 21;
    int[] twenties = new int[]{1375, 1379, 1383, 1387, 1391, 1395, 1399, 1403, 1407, 1408, 1411,
        1412,
        1415, 1416, 1419};
