...
public interface Calendar {
   ...
   * @see DateIntervalType
   */
  DateInterval toInterval(DateTimeUnit dateTimeUnit, DateIntervalType type, int offset,
      int length);
   ...
   * @see DateIntervalType
   */
  List<DateInterval> toIntervals(DateTimeUnit dateTimeUnit, DateIntervalType type, int offset,
      int length, int periods);
  ...
  /**
   * Gets week number using local DateUnit, week number is calculated based on ISO 8601 week
   * numbers
   *
   * @param dateTimeUnit DateUnit representing local year, month, day
   * @return Week number
