...
//            || CategoryCombo.class.isAssignableFrom( klass ) || CategoryOptionCombo.class.isAssignableFrom( klass );
  ...
  public <T extends IdentifiableObject> T get(PreheatIdentifier identifier, T object) {
    ...
    if (PreheatIdentifier.CODE == identifier || (reference == null
        && PreheatIdentifier.AUTO == identifier)) {
  ...
  public boolean containsKey(PreheatIdentifier identifier,
      Class<? extends IdentifiableObject> klass, String key) {
    return !(isEmpty() || isEmpty(identifier) || isEmpty(identifier, klass)) && map.get(identifier)
        .get(klass).containsKey(key);
  }
  ...
  public boolean isEmpty(PreheatIdentifier identifier, Class<? extends IdentifiableObject> klass) {
    return isEmpty(identifier) || !map.get(identifier).containsKey(klass) || map.get(identifier)
        .get(klass).isEmpty();
  }
  ...
  public <T extends IdentifiableObject> Preheat put(PreheatIdentifier identifier,
  ...
  public void setUniqueAttributeValues(
      Map<Class<?>, Map<String, Map<String, String>>> uniqueAttributeValues) {
