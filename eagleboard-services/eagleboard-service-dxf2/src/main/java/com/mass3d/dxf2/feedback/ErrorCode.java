...
/**
 * E3000 - E3999: Security Errors E4000 - E4999: Metadata Validation Errors E5000 - E5999: Preheat
 * Errors E6000 - E6999: Metadata Import Errors E7000 - E7099: Scheduling errors
 *
 */
public enum ErrorCode {
  ...
  E4007(
      "Allowed size range for collection property `{0}` is [{1} to {2}], but size given was {3}."),
  ...
  E4012(
      "Attribute `{0}` contains elements of different period type than the data set it was added to"),
  ...
  E4016(
      "Object referenced by the `{0}` property is already associated with another object, value: `{1}`"),
  ...
  /* Scheduling errors */
  E7000(
      "Failed to add/update job configuration - Another job of the same job type is already scheduled with this cron expression"),
  E7001(
      "Failed to add/update job configuration - Trying to add job with continuous exection while there already is a job with continuous exectution of the same job type."),
  ...
  E5004(
      "Id `{0}` for type `{1}` exists on more than 1 object in the payload, removing all but the first found.");
