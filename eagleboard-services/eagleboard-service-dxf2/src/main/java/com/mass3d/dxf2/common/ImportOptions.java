 ...
 * can also be defined for specific objects such as dataFieldIdScheme. The
...
public class ImportOptions
{
    ...
    public ImportOptions setDataFieldIdScheme( String idScheme )
    {
...
//    }
    ...
    public ImportOptions setTodoTaskIdScheme( String idScheme )
    {
        idSchemes.setTodoTaskIdScheme( idScheme );
        return this;
    }
