...
import static com.mass3d.common.DimensionType.*;
import static com.mass3d.common.DimensionType.CATEGORY;
import static com.mass3d.common.DimensionType.CATEGORY_OPTION_GROUP_SET;
import static com.mass3d.common.DimensionType.DATA_ELEMENT_GROUP_SET;
import static com.mass3d.common.DimensionType.DATA_X;
import static com.mass3d.common.DimensionType.ORGANISATION_UNIT;
import static com.mass3d.common.DimensionType.ORGANISATION_UNIT_GROUP_SET;
import static com.mass3d.common.DimensionType.PERIOD;
import static com.mass3d.common.DimensionType.PROGRAM_ATTRIBUTE;
import static com.mass3d.common.DimensionType.PROGRAM_DATA_ELEMENT;
import static com.mass3d.common.DimensionType.PROGRAM_INDICATOR;
import static com.mass3d.common.DimensionalObjectUtils.COMPOSITE_DIM_OBJECT_ESCAPED_SEP;
import static com.mass3d.common.IdentifiableObjectUtils.getUids;
import static com.mass3d.commons.util.TextUtils.splitSafe;
...
import com.mass3d.common.DimensionalObjectUtils;
...
import com.mass3d.common.ReportingRateMetric;
...
@Service( "com.mass3d.dimension.DimensionService" )
...
//                return operand;
//            }
            if ( ( reportingRate = getReportingRate( idScheme, id0, id1 ) ) != null )
            {
