...
import com.mass3d.logging.LogFormat;
...
@Service( "com.mass3d.system.SystemService" )
...
//    @Autowired
    ...
    public SystemInfo getSystemInfo()
    {
        ...
        info.setIntervalSinceLastAnalyticsTableSuccess( DateUtils
            .getPrettyInterval( lastAnalyticsTableSuccess, now ) );
