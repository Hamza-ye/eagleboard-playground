...
public final class QueryUtils {
  ...
  public static <T> T getEnumValue(Class<T> klass, String value) {
    Optional<? extends Enum<?>> enumValue = Enums
        .getIfPresent((Class<? extends Enum>) klass, value);
    ...
    if (enumValue.isPresent()) {
      ...
      throw new QueryParserException(
          "Unable to parse `" + value + "` as `" + klass + "`, available values are: " + Arrays
   ...
   * @return a string which is concat of list fields, separate by comma character. If input is null,
   * return "*" means the query will select all fields.
   */
   ...
   * @return a string contains an sql expression with operator and value. Example
   * parseFilterOperator('eq', 5)  will return "=5"
   */
   ...
   */
  @Nonnull
  public static List<Order> convertOrderStrings(@Nullable Collection<String> orders,
