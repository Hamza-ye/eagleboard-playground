...
public class ExpressionUtilsTest
{
    ...
    public void testEvaluateToDouble()
    {
        ...
        assertEquals( 2d, ExpressionUtils
            .evaluateToDouble( "d2:oizp(-4) + d2:oizp(0) + d2:oizp(3.0)", null ), DELTA );
        assertEquals( 3d, ExpressionUtils
            .evaluateToDouble( "d2:daysBetween('2015-03-01','2015-03-04')", null ), DELTA );
    ...
    public void testEvaluate()
    {
        ...
        assertEquals( "yes", ExpressionUtils
            .evaluate( "d2:condition(\"'goat' == 'goat'\",'yes','no')", null ) );
        assertEquals( "no", ExpressionUtils
            .evaluate( "d2:condition(\"'goat' != 'goat'\",'yes','no')", null ) );
        assertEquals( "indoor", ExpressionUtils
            .evaluate( "d2:condition(\"'weather' == 'nice'\",'beach','indoor')", null ) );
    }
