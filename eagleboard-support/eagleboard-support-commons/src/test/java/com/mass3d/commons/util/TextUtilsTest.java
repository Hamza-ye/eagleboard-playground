...
import static com.mass3d.commons.util.TextUtils.htmlLinks;
import static com.mass3d.commons.util.TextUtils.subString;
import static com.mass3d.commons.util.TextUtils.trimEnd;
...
public class TextUtilsTest
{
    ...
    {
        assertEquals( new ArrayList<>( Arrays.asList( "John", "Doe", "Main", "Road", "25" ) ), TextUtils
            .getTokens( "John Doe Main Road 25" ) );
        assertEquals( new ArrayList<>( Arrays.asList( "Ted,Johnson", "Upper-Road", "45" ) ), TextUtils
            .getTokens( "Ted,Johnson Upper-Road 45" ) );
    }
    ...
    {
        assertEquals( "green-red-blue", TextUtils
            .join( Arrays.asList( "green", "red", "blue" ), "-", "[n/a]" ) );
        assertEquals( "green-[n/a]-blue", TextUtils
            .join( Arrays.asList( "green", null, "blue" ), "-", "[n/a]" ) );
        assertEquals( "green-red-[n/a]", TextUtils
            .join( Arrays.asList( "green", "red", null ), "-", "[n/a]" ) );
        assertEquals( "greenred[n/a]", TextUtils
            .join( Arrays.asList( "green", "red", null ), null, "[n/a]" ) );
    ...
    {
        assertEquals( "green;red;blue,orange", TextUtils
            .replaceFirst( "green,red,blue,orange", ",", ";", 2 ) );
        assertEquals( "green.red.blue-orange", TextUtils
            .replaceFirst( "green-red-blue-orange", "-", ".", 2 ) );
    ...
    {        
        String actual = TextUtils
            .replace( "select * from {table} where {column} = 'Foo'", "{table}", "dataelement", "{column}", "name" );
        
        assertEquals( "select * from dataelement where name = 'Foo'", actual );
        
        actual = TextUtils
            .replace( "Hi [name] and welcome to [place]", "[name]", "Frank", "[place]", "Oslo" );
