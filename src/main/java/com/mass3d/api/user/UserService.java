...
public interface UserService {
   ...
   * #encodeAndSetPassword(UserCredentials, String) encodeAndSetPassword} and not directly on the
   * User or UserCredentials object.
   * <p>
  ...
  /**
   * Encodes and sets the password of the UserCredentials. Due to business logic required on
   * password updates the password for a user should only be changed using this method or {@link
   * #encodeAndSetPassword(User, String) encodeAndSetPassword} and not directly on the User or
