...
public class GenericStoreImp<T>
    implements GenericStore<T> {

  private static final Log log = LogFactory.getLog(GenericStoreImp.class);
   ...
   * @return executable TypedQuery
   */
  protected final TypedQuery<T> getTypedQuery(CriteriaBuilder builder,
