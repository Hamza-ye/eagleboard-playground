...
import com.mass3d.services.core.query.planner.QueryPlan;
import com.mass3d.services.core.query.planner.QueryPlanner;
...
public class CriteriaQueryEngine<T extends IdentifiableObject>
  ...
  private DetachedCriteria buildCriteria(DetachedCriteria detachedCriteria, Query query) {
    ...
    for (com.mass3d.services.core.query.Criterion criterion : query.getCriterions()) {
  ...
  private void addCriterion(org.hibernate.criterion.Junction criteria,
      com.mass3d.services.core.query.Criterion criterion) {
    if (Restriction.class.isInstance(criterion)) {
      ...
      for (com.mass3d.services.core.query.Criterion c : ((Junction) criterion).getCriterions()) {
