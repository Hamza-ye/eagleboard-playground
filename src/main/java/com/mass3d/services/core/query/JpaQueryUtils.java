...
public class JpaQueryUtils
{
   ...
   */
  @Nullable
  public static String createOrderExpression( @Nullable List<com.mass3d.services.core.query.Order> orders, @Nullable String alias )
  {
    if ( orders == null )
    {
      return null;
    ...
    return StringUtils
        .defaultIfEmpty( orders.stream().filter(com.mass3d.services.core.query.Order::isPersisted ).map( o -> {
   ...
   */
  @Nullable
  public static String createSelectOrderExpression( @Nullable List<com.mass3d.services.core.query.Order> orders, @Nullable String alias )
  {
    if ( orders == null )
    {
      return null;
  ...
  private static boolean isIgnoreCase(com.mass3d.services.core.query.Order o )
  {
