package com.mass3d.services.core.common.hibernate;

import com.mass3d.api.common.AuditLogUtil;
...
import com.mass3d.services.acl.AccessStringHelper;
import com.mass3d.services.acl.AclService;
import com.mass3d.services.core.query.JpaQueryUtils;
import com.mass3d.support.hibernate.HibernateGenericStore;
import com.mass3d.support.hibernate.InternalHibernateGenericStore;
import com.mass3d.support.hibernate.JpaQueryParameters;
import com.mass3d.support.hibernate.exception.CreateAccessDeniedException;
import com.mass3d.support.hibernate.exception.DeleteAccessDeniedException;
import com.mass3d.support.hibernate.exception.ReadAccessDeniedException;
import com.mass3d.support.hibernate.exception.UpdateAccessDeniedException;
...
//    return forceAcl() || (aclService.isShareable( clazz ) && !(user == null || user.isSuper()));
    return (aclService.isShareable( clazz ) && !(user == null || user.isSuper()));
  }
...
//    return forceAcl() || (aclService.isShareable( clazz ) && !(userInfo == null || userInfo.isSuper()));
    return (aclService.isShareable( clazz ) && !(userInfo == null || userInfo.isSuper()));
  }
