...
import com.mass3d.common.IdentifiableObjects;
...
import com.mass3d.dxf2.metadata.collection.CollectionService;
...
@ApiVersion( { EagleboardApiVersion.DEFAULT, EagleboardApiVersion.ALL } )
public abstract class AbstractCrudController<T extends IdentifiableObject>
{
    ...
    // Dependencies
    //--------------------------------------------------------------------------
    protected static final Log log = LogFactory.getLog( AbstractCrudController.class );
...
//    }
        ...
        throws QueryParserException
    {
        ...
        log.info("1- Query objects: " + query.getObjects());
        log.info("1- Query Class: " + query.getSchema().getKlass());
